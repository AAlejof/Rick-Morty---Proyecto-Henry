...
function Favorites(props) {
    ...
    return (
        <>
            <h1 class={styles.h1} id="h1">Favorites</h1>

            <div className={styles.divSelectReset}>
                <select className={styles.select1} name='order' defaultValue={'DEFAULT'} onChange={handleClick}>
                ...
                <select className={styles.select2} name='filter' defaultValue={'DEFAULT'} onChange={handleClick}>
            ...
            {myFavorites.length > 0 && (<a href="#h1"><button className={styles.upButton}>Up!</button></a>)}
        </>
    );
}
